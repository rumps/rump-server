...
describe('tasks', function() {
  ...
  it('are added and defined', () => {
    ...
    gulp.tasks['spec:info:server'].should.be.ok()
    gulp.tasks['spec:server'].should.be.ok()
    gulp.tasks['spec:server:prod'].should.be.ok()
  })
  ...
  describe('for serving', () => {
    ...
    before(async() => {
      ...
      await new Promise(resolve => {
        gulp.task('postserve', ['spec:server'], resolve)
